	...
	<body>
		...
		<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-body contentbox">
				...
				<div class="formbox">
					<form action="api/Admin-action-add.php" method="post" name="myform" onsubmit="return CheckPost();" class="layui-form">  
						<label class="formtitle">新增管理员</label>
		...
		        { 
		            alert("请填写用户账号"); 
		            myform.adminID.focus(); 
		            return false; 
		        }
				if (myform.adminName.value=="") 
		        { 
		            alert("请填写用户名"); 
		            myform.adminName.focus(); 
		            return false; 
		        } 
				if (myform.adminPwd.value=="") 
		        { 
		            alert("请填写密码"); 
		            myform.adminPwd.focus(); 
		            return false; 
		        } 
		    } 
		</script>
